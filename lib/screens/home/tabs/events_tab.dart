...
import 'package:todo_c15_str/screens/edit%20event/edit_event.dart';
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: (){
                  Navigator.pushNamed(context,EditEventScreen.routeName,arguments: snapShot.data?.docs[index].data());
                },
                child: Container(
                  height: 203,
